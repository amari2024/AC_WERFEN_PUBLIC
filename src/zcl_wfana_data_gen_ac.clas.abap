class zcl_wfana_data_gen_ac definition
  public
  final
  create public .
...
class zcl_wfana_data_gen_ac implementation.
...
*last_changed_at       : abp_lastchange_tstmpl;
 ...
 data: lt_acc_categ type table of ZWA_TB_ACC_CATEG,
          ...
          lt_clnts_lib type table of ZWA_TB_CLINT_LIB,
          lt_libros    type table of ZWA_TB_LIBROS.
...
******** ZWA_TB_ACC_CATEG ********
    ...
    delete from ZWA_TB_ACC_CATEG.
    insert ZWA_TB_ACC_CATEG from table @lt_acc_categ.
...
******** ZWA_TB_CATEG ********
    ...
    "Delete possible entries; insert new entries
    delete from ZWA_TB_CATEG.
    insert ZWA_TB_CATEG from table @lt_catego.
...
******** ZWA_TB_CLIENTES ********
    ...
    "Delete possible entries; insert new entries
    delete from ZWA_TB_CLIENTES.
    insert ZWA_TB_CLIENTES from table @lt_clientes.
...
******** ZWA_TB_CLINT_LIB
    ...
    "Delete possible entries; insert new entries
    delete from ZWA_TB_CLINT_LIB.
    insert ZWA_TB_CLINT_LIB from table @lt_clnts_lib.
...
******** ZWA_TB_LIBROS ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ZWA_TB_LIBROS.
    insert ZWA_TB_LIBROS from table @lt_libros.
